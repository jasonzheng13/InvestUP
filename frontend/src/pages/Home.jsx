    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
            ...
            <header className="bg-white bg-opacity-80 background-blur-sm shadow-sm sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-2xl font-bold text-gray-800">Up</span>
                    </div>
            ...
            <main className="max-w-7xl mx-auto px-7 py-7">
              <div className="flex flex-col md:flex-row gap-6 cards-map-container">
                {/* Left: Cards (70%) */}
                <div className="w-full md:w-[60%] h-[200px] cards-left">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-6 h-full auto-rows-fr cards-grid">
                ...
                {/* Right: Map (30%) */}
                <div className="w-full md:w-[30%] map-right">
